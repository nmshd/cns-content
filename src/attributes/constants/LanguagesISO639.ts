...
export const LANGUAGES_ISO639_TO_DISPLAY_NAME = new Map<string, LanguageDefinition>([
    ...
    ["ar", { code: "ar", name: "Arabic", nativeName: "اَلْعَرَبِيَّةُ" }],
    ...
    ["bo", { code: "bo", name: "Tibetan", nativeName: "བོད་ཡིག" }],
    ...
    ["dv", { code: "dv", name: "Divehi", nativeName: "ދިވެހި" }],
    ...
    ["gn", { code: "gn", name: "Guaraní", nativeName: "Avañe'ẽ" }],
    ...
    ["lu", { code: "lu", name: "Luba-Katanga", nativeName: "Kiluba" }],
    ...
    ["na", { code: "na", name: "Nauru", nativeName: "Dorerin Naoero" }],
    ...
    ["tk", { code: "tk", name: "Turkmen", nativeName: "Türkmençe" }],
